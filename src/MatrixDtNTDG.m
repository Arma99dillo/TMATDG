function A = MatrixDtNTDG(self)

% Build the Dtn-TDG matrix in the Dirichlet case

% get parameters
mesh=self.mesh; param=self.param;
t=mesh.t; p=mesh.p; B=mesh.B; K=param.K; LI=mesh.LI; alpha=param.alpha; 
beta=param.beta; delta=param.delta; LDtN=mesh.LDtN;
LDir=mesh.LDir; M=param.M; R=param.R; nd=param.nd; d=param.d;
